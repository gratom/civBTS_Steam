...
class CvMainInterface:
	...
	def interfaceScreen (self):
		...
		screen.setImageButton( "ClimateAdvisorButton", "Art/Interface/Buttons/TechTree/climat.dds", iBtnX, iBtnY, iBtnWidth, iBtnWidth, WidgetTypes.WIDGET_GENERAL, 777, -1 )
		screen.hide( "ClimateAdvisorButton" )
	...
	def updateMiscButtons( self ):
		...
		if ( CyInterface().getShowInterface() == InterfaceVisibility.INTERFACE_HIDE_ALL or CyInterface().getShowInterface() == InterfaceVisibility.INTERFACE_MINIMAP_ONLY ):
			...
			screen.show( "ClimateAdvisorButton" )
			...
			screen.moveToFront( "ClimateAdvisorButton" )
